...
mod perft {
    ...
    fn kiwipete_6() {
        ...
        .unwrap();
        assert_eq!(perft(&startpos, 6), 8_031_647_685);
    }

    #[test]
    fn pawn_blocks() {
        let startpos = Board::from_fen(
            "r6r/p1p1qpb1/bn1kpQp1/3P4/1p2P3/2N4p/PPPBBPPP/R3K2R w KQ - 1 3"
        )
        .unwrap();
        assert_eq!(perft(&startpos, 2), 1_875);
    }
    ...
    fn cpwpos4_6() {
        let startpos =
            Board::from_fen("r3k2r/Pppp1ppp/1b3nbN/nP6/BBP1P3/q4N2/Pp1P2PP/R2Q1RK1 w kq - 0 1")
                .unwrap();
        assert_eq!(perft(&startpos, 6), 706_045_033);
    }
    ...
    fn cpwpos6_6() {
        ...
        .unwrap();
        assert_eq!(perft(&startpos, 6), 6_923_051_137);
    }
}
